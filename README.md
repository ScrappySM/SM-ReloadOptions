...
Welcome to your new DLL mod, you should see you now have a `SM-ReloadOptions.sln` file, all the files you see here were generated from the template.

## Usage

1. Clone this repository locally
2. Open the `SM-ReloadOptions.sln` file in Visual Studio
...
6. You can then view the https://github.com/ScrappySM/SM-ReloadOptions/releases to see your mod's release page, edit the draft and publish it when you are ready.
